...
namespace HideOut
{
    public class Loader
    {
        ...
        public Loader() 
        {
            // Use writable location for save files
            string appDataPath = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData);
            string saveDirectory = Path.Combine(appDataPath, "HideOut", "SaveData");
            Directory.CreateDirectory(saveDirectory);
            _saveFilePath = Path.Combine(saveDirectory, "SaveGame.txt");
        }
                                ...
                                , ref BuffManager buffManager, ref IItemFactory wFactory, ref HashSet<Item> items)
        {
            ...
            // Check if save file exists before trying to read
            ...
            _reader = new StreamReader(_saveFilePath);
            try
            {
